...
<html lang="id">
  <head>
    ...
    <meta name="description" content="Source Code Sistem Informasi Geografis (SIG) berbasis web dengan PHP dan MySQL. Studi kasus: Rumah Sakit Grobokan ."/>
    <meta name="keywords" content="Sistem, Informasi, geografis,SIG, Tugas Akhir,UAS,Source Code, PHP, MySQL, CSS, JavaScript, Bootstrap, jQuery"/>
  ...
  <body>
    ...
    <footer class="footer bg-primary">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> Mujabers <em class="pull-right">18 Januari 2023</em></p>
      </div>
    </footer>
</body>
</html>